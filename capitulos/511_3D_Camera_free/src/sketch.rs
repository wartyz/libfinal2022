...
impl Sketch {
    pub fn new() -> Sketch {
        ...
        let mut camera = Camera3D::perspective(
            Vector3::new(10.0, 10.0, 10.0), // posición
    ...
    pub fn update(&mut self, rl: &mut RaylibHandle, th: &RaylibThread) -> bool {
        ...
        if self.engine.param.key == CodigosTecla::Z {
            self.camera.target = Vector3::new(0.0, 0.0, 0.0);
        }
    ...
    pub fn draw(&mut self, rl: &mut RaylibHandle, th: &RaylibThread) {
...

        {
            ...
            let position2 = Vector4::new(2.0, 2.0, 2.0, 0.0);
        ...
        fill(Color::new(102, 191, 255, 255), &mut self.engine.param); //SKYBLUE
        stroke(Color::new(0, 0, 255, 255), &mut self.engine.param); //BLUE
        rect(&mut d, &mut self.engine.param, 10.0, 10.0, 320.0, 133.0);

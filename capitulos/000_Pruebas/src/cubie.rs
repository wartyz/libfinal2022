...
use libfinal::transform::{translate, Matrix3x3};
use libfinal::transform3d::{
    apply_matrix3d, identity4x4, pop_matrix3d, push_matrix3d, rotate_z3d, scale1_3d, translate3d,
    Matrix4x4,
};
...
impl Cubie {
    ...
    pub fn show(&self, d: &mut RaylibDrawHandle, param: &mut Parametros) {
        ...
        //self.engine.param.matriz_total3d = identity4x4();
        //rotate_z3d(PI / 4.0, param);
        //translate3d(-1.5, 0.0, 0.0, &mut self.engine.param);
        //translate3d(1.0, 0.0, 0.0, &mut self.engine.param);
        //self.pba();
